...
import com.wiser.library.WISERApp;
...
public final class CameraManager {
	...
	public static void init(Context context) {
		...
		setInitValueResolution(context);
	}

	// 计算分辨率设置初始值
	private static void setInitValueResolution(Context context) {
		int resolution = 0;
		if (WISERApp.getScreenDisplay(context).length > 0) {
			resolution = WISERApp.getScreenDisplay(context)[0];
		}
